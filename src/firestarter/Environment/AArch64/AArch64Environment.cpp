...
void AArch64Environment::evaluateFunctions() {
...
int AArch64Environment::selectFunction(unsigned functionId,
...
int AArch64Environment::selectInstructionGroups(std::string groups) {
...
void AArch64Environment::setLineCount(unsigned lineCount) {
  this->selectedConfig().setLineCount(lineCount);
}

void AArch64Environment::printSelectedCodePathSummary() {
  this->selectedConfig().printCodePathSummary();
}

void AArch64Environment::printFunctionSummary() {
