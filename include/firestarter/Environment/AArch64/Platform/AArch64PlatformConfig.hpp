...
class AArch64PlatformConfig : public environment::platform::PlatformConfig {
private:
  unsigned _family;
...
public:
  AArch64PlatformConfig(std::string name, unsigned family,
                    ...
                    unsigned currentThreads, payload::AArch64Payload *payload)
