...
private:
  ...
  const std::list<std::shared_ptr<firestarter::environment::platform::PlatformConfig>> PlatformConfigs = {
  ...
  const std::list<std::shared_ptr<firestarter::environment::platform::PlatformConfig>> FallbackPlatformConfigs = {
