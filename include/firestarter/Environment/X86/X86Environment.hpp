...
private:
  /// The list of availabe platform configs that is printed when supplying the --avail command line argument. The
  /// IDs for these configs are generated by iterating through this list starting with 1. To maintain stable IDs in
