...
public:
  ...
  [[nodiscard]] auto platformConfigs() const
      -> const std::vector<std::shared_ptr<firestarter::environment::platform::PlatformConfig>>& override {
...
private:
  ...
  const std::vector<std::shared_ptr<firestarter::environment::platform::PlatformConfig>> PlatformConfigs = {
  ...
  const std::vector<std::shared_ptr<firestarter::environment::platform::PlatformConfig>> FallbackPlatformConfigs = {
